...
def get_common_movie_ratings(file_path, common_movies, imsdb_to_common):
    ...
    with open(file_path) as rating_file:
...
def get_rating_matrix():
    ...
    movielens_movie_path = os.path.join(current_path, 'dataset/movie.csv')
    movielens_rating_path = os.path.join(current_path, 'dataset/rating.csv')
